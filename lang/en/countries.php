...
return [
    ...
    "cameroon" => "Cameroon",
    "canada" => "Canada",
    "canton_and_enderbury_islands" => "Canton and Enderbury Islands",
    ...
    "dronning_maud_land" => "Dronning Maud Land",
    ...
    "french_southern_and_antarctic_territories" => "French Southern and Antarctic Territories",
    "gabon" => "Gabon",
    "gambia" => "Gambia",
    "georgia" => "Georgia",
    "germany" => "Germany",
    ...
    "guernsey" => "Guernsey",
    "guinea" => "Guinea",
    "guinea-_bissau" => "Guinea-Bissau",
    "guyana" => "Guyana",
    "haiti" => "Haiti",
    "heard_island_and_mc_donald_islands" => "Heard Island and McDonald Islands",
    "honduras" => "Honduras",
    "hong_kong_s_a_r_china" => "Hong Kong SAR China",
    "hungary" => "Hungary",
    "iceland" => "Iceland",
    "india" => "India",
    "indonesia" => "Indonesia",
    ...
    "macau_s_a_r_china" => "Macau SAR China",
    "macedonia" => "Macedonia",
    ...
    "paraguay" => "Paraguay",
    "peoples_democratic_republic_of_yemen" => "People's Democratic Republic of Yemen",
    "peru" => "Peru",
    ...
    "u_s_miscellaneous_pacific_islands" => "U.S. Miscellaneous Pacific Islands",
    "u_s_virgin_islands" => "U.S. Virgin Islands",
    "uganda" => "Uganda",
    "ukraine" => "Ukraine",
    "union_of_soviet_socialist_republics" => "Union of Soviet Socialist Republics",
